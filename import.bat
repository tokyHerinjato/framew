...
set out_jar=D:\Andry\ITU\S5\Naina\Sprint\Sprint-12
...
if exist D:\Andry\ITU\S5\Naina\Sprint\Sprint-12\proj\WEB-INF\lib\FrontServlet.jar (
    del D:\Andry\ITU\S5\Naina\Sprint\Sprint-12\proj\WEB-INF\lib\FrontServlet.jar
)
copy FrontServlet.jar D:\Andry\ITU\S5\Naina\Sprint\Sprint-12\proj\WEB-INF\lib
